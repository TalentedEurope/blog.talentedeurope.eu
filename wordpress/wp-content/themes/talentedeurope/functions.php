...
*/
/*
if ( ! function_exists( 'bogo_talented' ) ) :

add_shortcode( 'bogot', 'bogo_talented' );

function bogo_talented( $args = '' ) {
  ...
  foreach ( $links as $link ) {
    ...
    $title = $link['title'];
    $lang = $link['lang'];
    $lang = strtoupper(explode("-", $lang)[0]);
...
$items .= '<form method="get" class="menu-search-form" action="' . get_bloginfo('home') . '/"><p><input class="text_input search-field" type="text" name="s" placeholder="' . esc_attr_x( 'Search&hellip;', 'placeholder', 'sparkling' ) . '"    />

<button type="submit" class="search-submit btn btn-default" name="submit" id="searchsubmit" value="Search">
